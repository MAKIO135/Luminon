...
boolean randomDisplay = true;
int delayDisplay = 100000;
int startTime = 0;
...
void updateGraphics() {
  ...
  // k2000 horizontal
    ...
    left.fill(255);
    for (int i = 0; i<ph; i++) {
      if (i%2==0) left.rect(abs(sin(radians(frameCount*2)))*pw, i, 1, 1);
      else left.rect(pw-(abs(sin(radians(frameCount*2)))*pw), i, 1, 1);
    }
    left.endDraw();
    ...
    if (frameCount%base==0) {
      for (int i = 0; i<3; i++) {
        right.rect(int(random(pw)), 0, 1, ph);
      }
    }
    right.endDraw();
  }
    ...
    if (frameCount%15==0) {
      for (int i = 0; i<pw; i++) {
        left.rect(i, int(random(ph-1)), 1, 2);
      }
    }
    left.endDraw();
    ...
    left.noStroke();
    left.rect(0, 0, pw, ph);
    left.fill(80+175*noise(frameCount/50.));
    left.rect(0, 0, pw, ph);
    left.endDraw();
    ...
    left.rect(0, 0, pw, ph);
    left.fill(255);
    left.rect(noise((frameCount)/50.)*15%pw, 0, 1, ph);
    left.endDraw();
    ...
    right.rect(0, 0, pw, ph);
    right.fill(255);
    right.rect(noise((450-frameCount)/50.)*15%pw, 0, 1, ph);
    right.endDraw();
  }
    ...
    left.rect(0, 0, pw, ph);
    left.fill(255);
    left.rect(frameCount/10%pw, 0, 1, ph);
    left.endDraw();
  ...
  else if (displayMode == 25) {
    left.beginDraw();
    left.fill(0, 20);
    left.noStroke();
    left.rect(0, 0, pw, ph);
    left.fill(255);
    left.rect((frameCount/2)%(pw*2), 0, 1, ph);
    left.endDraw();
    ...
    right.rect(0, 0, pw, ph);
    right.fill(255);
    right.rect((frameCount/2-pw)%(pw*2), 0, 1, ph);
    right.endDraw();
  }

  else if (displayMode == 26) {
    left.beginDraw();
    left.fill(0, 20);
    left.noStroke();
    left.rect(0, 0, pw, ph);
    left.fill(255);
    left.rect(frameCount%(pw*2), (frameCount/3)%ph, 1, 1);
    left.rect(frameCount%(pw*2), 2+(frameCount/3)%ph, 1, 1);
    left.endDraw();
    ...
    right.rect(0, 0, pw, ph);
    right.fill(255);
    right.rect((frameCount-pw)%(pw*2), (frameCount/3)%ph, 1, 1);
    right.rect((frameCount-pw)%(pw*2), (2+frameCount/3)%ph, 1, 1);
    right.endDraw();
  }
    ...
    left.rect(0, 0, pw, ph);
    left.fill(255);
    left.rect(frameCount%(pw*2), frameCount%ph, 1, 1);
    left.rect(frameCount%(pw*2), (frameCount+2)%ph, 1, 1);
    left.endDraw();
    ...
    right.rect(0, 0, pw, ph);
    right.fill(255);
    right.rect(pw-((frameCount-pw)%(pw*2)), frameCount%ph, 1, 1);
    right.rect(pw-((frameCount-pw)%(pw*2)), (frameCount+2)%ph, 1, 1);
    right.endDraw();
  }

  else if (displayMode == 28) {
    left.beginDraw();
    left.fill(0, 20);
    left.noStroke();
    left.rect(0, 0, pw, ph);
    ...
    right.rect(0, 0, pw, ph);
    right.fill(255);
    right.rect(pw-((frameCount/2-pw)%(pw*2)), 0, 1, ph);
    right.endDraw();
  }

  else if (displayMode == 29) {
    left.beginDraw();
    left.fill(0, 20);
    left.noStroke();
    left.rect(0, 0, pw, ph);
    ...
    for (int i=0;i<ph;i+=2) {
      left.rect((frameCount/3)%(pw*2), i, 1, 1);
    }
    left.endDraw();
    ...
    right.fill(255);
    for (int i=0;i<ph;i+=2) {
      right.rect(pw-((frameCount/3-pw)%(pw*2)), i, 1, 1);
    } 
    right.endDraw();
  }
    ...
    left.noStroke();
    left.rect(0, 0, pw, ph);
    left.fill((frameCount/4)%2==0?255:0);
    left.rect(0, 0, pw, ph);
    left.endDraw();
    ...
    right.noStroke();
    right.rect(0, 0, pw, ph);
    right.fill((frameCount/4)%2==0?0:255);
    right.rect(0, 0, pw, ph);
    right.endDraw();
  }
    ...
    for (int i = 0; i < in.bufferSize() - 1; i++) {
      vertex(i, ph/2 + in.left.get(i)*50); 
      vertex(i+1, ph/2 + in.left.get(i+1)*50);
    }
    left.endShape(CLOSE);
    left.endDraw();
